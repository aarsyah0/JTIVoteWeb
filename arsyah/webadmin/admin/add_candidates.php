...
?>
    <div class="alert alert-danger my-3" role="alert">
        Candidate image is too large, please upload a smaller file (you can upload any image up to 2 MBs.).
    </div>
<?php
            ...
            <tbody>
                ...
                ?>
                            <tr>
                                ...
                                <td> 
                                <a href="edit_candidate.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning btn-edit"> Edit </a>
                                <a href="delete_candidate.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger btn-delete"> Delete </a>
...
<?php 
    if(isset($_POST['addCandidateBtn'])) {
        ...
        $targetted_folder = "../assets/imgs/candidate_photos/";
